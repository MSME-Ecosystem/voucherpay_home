...
<head>
    ...
    <script
        src="https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/run_prettify.js?lang=node&amp;skin=sunburst"></script>
...
<body>
    <div id="__next">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="main-banner-woman-content pt-5">
                            ...
                            <p>Reaching Africa remotest parts with digital financial services</p>
                            <ul class="btn-list">
                                <li><a class="btn btn-primary bg-#00CCFF" href="contact.html">Get Started</a></li>
                                <li>
                                    <a class="discover-more-btn" href="./contact.php">Talk to sales<i
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="main-banner-woman-image"><img src="./assets/images/new-img/Untitled design.gif"
                                alt="image" width="500" />
        ...
        <div class="partner-style-area pb-60">
            <div class="container">
                <block class="trusted-by d-flex align-items-center">Trusted By:</block>
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-2 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/logos/Truss web-d1.png" alt="image"
                                width="60" /></div>
                    </div>
                    <div class="col-lg-1 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/logos/Truss web-d2.png" alt="image"
                                width="60" /></div>
                    </div>
                    <div class="col-lg-2 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/logos/Truss web-d4.png" alt="image"
                                width="60" /></div>
                    </div>
                    <div class="col-lg-1 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/logos/Truss web-d5.png" alt="image"
                                width="100" /></div>
                    </div>
                    <div class="col-lg-2 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/logos/Truss web-d6.png" alt="image"
                                width="60" /></div>
                    </div>
                    <div class="col-lg-1 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/logos/Truss web-quick-D-.png"
                                alt="image" width="60" /></div>
                    </div>
                    <div class="col-lg-2 col-6 col-sm-3 col-md-3">
                        <div class="single-partner-card"><img src="assets/images/truted-by/msme.png" alt="image"
                                width="60" /></div>
                    </div>
                </div>
            </div>
        ...
        <div class="about-us-area ptb-60 bg-light">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-us-content">
                            <h3>Committed to ease, and accessible payment for the underserved</h3>
                            <p>Harness simplicity while sending or receiving funds from clients and customers. We secure
                                your money and ensure that you enjoy seamless transactions across all borders.
                            </p>
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-md-6">
                                    <ul class="list">
                                        <li><i class="flaticon-check-mark"></i> No transaction hooks</li>
                                        <li><i class="flaticon-check-mark"></i> Secure Payment for Goods and Services
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <ul class="list">
                                        <li><i class="flaticon-check-mark"></i> Near zero
                ...
                <div class="row m-4">
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-3 col-6">
                        <div class="funfact">
                            ...
                            <h3><span>1.5 Million</span></h3>
                            <p class="text-dark">Customers</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-md-3 col-6">
                        <div class="funfact">
                            <h3><span>$ 150 Million</span>+</h3>
                            <p class="text-dark">Transactions</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-md-3 col-6 ">
                        <div class="funfact">
                            <h3><span>7000</span>+</h3>
                            <p class="text-dark">Cooperatives</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-md-3 col-6">
                        <div class="funfact">
                            <h3><span>300000</span>+</h3>
                            <p class="text-dark">Businesses</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-md-3 col-6 ">
                        <div class="funfact">
                            <h3><span>9000</span>+</h3>
    ...
    <div class="funfacts-style-area pt-100 pb-75">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="security-services-card">
                        <div class="icon">
                            <img src="./assets/images/truted-by/Voucher Pay-payment icon.png" alt="" height="50" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="security-services-card">
                        <div class="icon">
                            <img src="./assets/images/icons/Voucher Pay-Terminal icon.png" alt="" height="50" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="security-services-card">
                        <div class="icon">
                            <img src="./assets/images/truted-by/Voucher Pay-voucher agent2.png" alt="" height="50" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="security-services-card">
                        <div class="icon">
                            <img src="./assets/images/icons/Voucher Pay-voucher cooperative icon.png" alt=""
                                height="50" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="security-services-card">
                        <div class="icon">
                            <img src="./assets/images/icons/Voucher Pay-consumer icon.png" alt="" height="50" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="security-services-card">
                        <div class="icon">
                            <img src="./assets/images/icons/Voucher Pay-business== icon.png" alt="" height="50" />
                        </div>
    ...
    <div class="container bg-#070d13 ptb-70">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-5 col-sm-12">
                ...
                <a class="btn btn-primary" target="_blank" rel="noreferrer noopener"
                    href="https://doc.voucherpay.online">Discover More</a>
            </div>
            <div class="col-lg-7     col-sm-12">
                <pre class="prettyprint">

<code> const data = {
      reference: "fgdsis9skdsklsuuyiisfso",
      first_name: "Adeseun",
      last_name: "Awwal",
      mobile_number:"+234 912345678",
      email: "user@voucherpay.online",
      nin: "1234567890",
      bvn: "0987654321",
    };
const config = {
...
const { data: responseData } = await axios(config);
    ...
    <div class="awesome-features-area pt-100 bg-light">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="awesome-features-image"><img
                            src="assets/images/new-img/Voucher Pay-lady with phone.png" alt="image" /></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="blog-wrap-area pt-100 pb-75 bg-light">
        <div class="container">
            <div class="wrap-section-title">
                <h2>We are making digital payments faster &amp; easier, so you can do more</h2>
            </div>
            <div class="row justify-content-left">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="image"><a class="d-block" href="#0"><img
                                    src="assets/images/truted-by/Voucher-pay-for-individual.png" alt="image" /></a>
                        </div>
                        <div class="content">
                            <h3><a href="#0">VOUCHERPAY FOR INDIVIDUALS</a>
                            </h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="image">
                            <a class="d-block" href="#0">
                                <img src="assets/images/new-img/Voucher Pay-terminals.png" alt="image" />
                            </a>
                        </div>
                        <div class="content">
                            <h3>
                            ...
                            <p>Voucherpay provides hardware solutions like the point of sale (POS) terminals for easy and quick payment transactions from customers to your business.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="image">
                            <a class="d-block" href="#0">
                                <img src="assets/images/new-img/VoucherPay-payment.png" alt="image" />
                            </a>
                        </div>
                        <div class="content">
                            <h3>
                            ...
                            <p>With Voucherpay Agent, agents can expand the Voucherpay market network and also provide third party  services on behalf of businesses to their customers.</p>
                        </div>
                    </div>
                </div>
